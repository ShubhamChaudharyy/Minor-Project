...
import FirebaseClass from "../../assets/jss/firebaseContext/context";
...
export default function Dashboard() {
  ...
  let firebase = new FirebaseClass();
  useEffect(() => {
    firebase.setData();
  });
  return (
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="warning" stats icon>
              ...
              <p className={classes.cardCategory}>Total Reports Uploaded</p>
              <h3 className={classes.cardTitle}>
                3/50 <small>10 GB</small>
              </h3>
            </CardHeader>
            <CardFooter stats>
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="success" stats icon>
              ...
              <p className={classes.cardCategory}>Non Symptomatic Reports</p>
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="danger" stats icon>
              ...
              <p className={classes.cardCategory}>Symptomatic Reports</p>
        ...
        <GridItem xs={12} sm={6} md={3}>
          <Card>
            <CardHeader color="info" stats icon>
              ...
              <p className={classes.cardCategory}>Unable to Detect</p>
